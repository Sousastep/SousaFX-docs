...
apt-get update
apt-get -y install git rsync python3-sphinx=5.3.0-7 python3-sphinx-rtd-theme python3-stemmer python3-git python3-pip python3-virtualenv python3-setuptools
 
python3 -m pip install --upgrade rinohtype pygments sphinx-design sphinx-rtd-dark-mode sphinx-new-tab-link sphinxcontrib-googleanalytics
...
<html>
   ...
   <body>
      <p>Please wait while you're redirected to the <a href="/${REPO_NAME}/en/master/">SousaFX Documentation</a>.</p>
   </body>
</html>
EOF
